...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card px-3 py-1">
        ...
        <form method="POST" action="<?php echo e(route('vouchers.update', ['id' => $voucher->id])); ?>" novalidate>
            <?php if($errors->any()): ?>
        ...
        <?php if($voucher->status === 0): ?>
            <form id="insertForm" method="POST" action="<?php echo e(route('vouchers.createExpense', ['id' => $voucher->id])); ?>"
                ...
                <div class="row">
                    <div class="form-group col-sm-6 col-md-3">
                        ...
                        <input type="date" class="form-control" id="date" name="date"
                            value="<?php echo e(isset($expense->date) ? $expense->date->format('Y-m-d') : date('Y-m-d')); ?>"
                            required>
                    </div>
                ...
                <div id="fuel_area" style="display: none">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-3">
                            ...
                            <input type="number" min="<?php if(isset($logbook)): ?><?php echo e($logbook->current_reading+1); ?><?php else: ?><?php echo e(0); ?> <?php endif; ?>" step=0.01 class="form-control" id="current_reading" name="current_reading"
                                >
                        </div>
                        <div class="form-group col-sm-6 col-md-3">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr <?php if($voucher->status === 0): ?> class="editExpenseBtn" <?php endif; ?>>
                            <td hidden class="data"><?php echo e($expense->id); ?></td>
                            ...
                            <td class="data">
                                <span class="badge badge-primary px-2 py-2" style="font-size: 1.1rem;">Rs.
                                    <?php echo e($expense->amount); ?></span>
                            </td>
                            <td class="data"><?php echo e($expense->description); ?></td>
                            <td>
                                
                                <?php if(count($expense->bills) > 0): ?>
                                    <a href="<?php echo e(asset('storage/bill/' . $expense->bills->first()->file_name)); ?>"
                                        target="_blank">
                                        <img src="<?php echo e(asset('storage/bill/' . $expense->bills->first()->file_name)); ?>"
                                            alt="" width="50">
                                    </a>
                                <?php else: ?>
        ...
        <?php if($voucher->status === 0): ?>
            <form id="extraFilesForm" method="POST"
                action="<?php echo e(route('vouchers.attachAdditionalFiles', ['id' => $voucher->id])); ?>"
                enctype="multipart/form-data">
                <?php if($errors->any()): ?>
                    <div class="border border-danger text-danger">
                        <ul>
